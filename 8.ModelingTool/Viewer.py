...
import color
from primitive import init_primitives, G_OBJ_SPHERE, G_OBJ_PLANE
from scene import Scene
from node import Sphere, SnowFigure
from interaction import Interaction


# Viewer类控制并管理整个程序的流程，它的main_loop方法是程序的入口
class Viewer(object):
    # 初始化Viewer类
    def __init__(self):
        # 初始化接口，创建窗口并注册渲染函数
    ...
    def create_sample_scene(self):
        ...
        snowFigure.translate(-2, 0, -2)
        snowFigure.scale(2)
        self.scene.add_node(snowFigure)
    ...
    # 鼠标选中一个节点,是否被选中以及哪一个被选中交由Scene下的pick处理
    def pick(self, x, y):
